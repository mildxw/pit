...
namespace PR7_PortaCipher
{
    ...
    public class PortaCipher
    {
        ...
        ///<exception cref="ArgumentException">Возникает в том случае, когда таблица кодов пуста или равна нулю</exception>
        ...
        ///<exception cref="ArgumentException">Возникает, если текст пустой или равен null</exception>
        ///<exception cref="KeyNotFoundException">Возникает, если код отсутствует в таблице кодов</exception>
